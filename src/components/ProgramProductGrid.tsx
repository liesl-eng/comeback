...
import { ArrowRight, ImageOff, Heart } from "lucide-react";
...
const ProgramProductGrid = ({ config }: { config: ProgramProductGridConfig }) => {
  ...
  return (
    <section id={config.anchorId} className="py-8 md:py-12 scroll-mt-20">
            ...
            {config.brands.map((b, i) => {
              ...
              return (
                <button
                  ...
                  className={
                    "px-3 py-1 rounded-full font-medium text-sm transition-colors border " +
                    (active
